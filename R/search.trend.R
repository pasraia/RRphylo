      ...
      if (dim(Srr)[1] > 0) {
        if (rbi.slopeR[i, 1] > 0) {
          p.rbi.slopeR[i] <- (rank(c(rbi.slopeR[i, 1],
                                     rbi.slopeRS[1:(nsim - 1), ]))[1] + 0.5*length(which(Srr[,
                                                                                             3] > 0.05 & Srr[, 4] < 0.05)))/nsim
        }
        else {
          p.rbi.slopeR[i] <- (rank(c(rbi.slopeR[i, 1],
                                     rbi.slopeRS[1:(nsim - 1), ]))[1] - 0.5*length(which(Srr[,
      ...
      if (dim(Saa)[1] > 0) {
        if (rbi.slopeA[i, 1] > 0) {
          p.rbi.slopeA[i] <- (rank(c(rbi.slopeA[i, 1],
                                     rbi.slopeRAS[1:(nsim - 1), ]))[1] + 0.5*length(which(Saa[,
                                                                                              3] > 0.05 & Saa[, 4] < 0.05)))/nsim
        }
        else {
          p.rbi.slopeA[i] <- (rank(c(rbi.slopeA[i, 1],
                                     rbi.slopeRAS[1:(nsim - 1), ]))[1] - 0.5*length(which(Saa[,
    ...
    if (dim(Srr)[1] > 0) {
      if (rbi.slopeR[1] > 0) {
        p.rbi.slopeR <- (rank(c(rbi.slopeR[1], rbi.slopesRS[1:(nsim -
                                                                 1)]))[1] + 0.5*length(which(Srr[, 3] > 0.05 &
                                                                                               Srr[, 4] < 0.05)))/nsim
      }
      else {
        p.rbi.slopeR <- (rank(c(rbi.slopeR[1], rbi.slopesRS[1:(nsim -
    ...
    if (dim(Saa)[1] > 0) {
      if (rbi.slopeA[1] > 0) {
        p.rbi.slopeA <- (rank(c(rbi.slopeA[1], rbi.slopesRAS[1:(nsim -
                                                                  1)]))[1] + 0.5*length(which(Saa[, 3] > 0.05 &
                                                                                                Saa[, 4] < 0.05)))/nsim
      }
      else {
        p.rbi.slopeA <- (rank(c(rbi.slopeA[1], rbi.slopesRAS[1:(nsim -
          ...
          if (dim(Srr)[1] > 0) {
            if (rbi.slopeR.sel[[k]][i, 1] > 0) {
              pR[i] <- (rank(c(rbi.slopeR.sel[[k]][i,
                          ...
                          0.5*length(which(Srr[, 3] > 0.05 & Srr[,
                                                                 4] < 0.01)))/nsim
            }
            else {
              pR[i] <- (rank(c(rbi.slopeR.sel[[k]][i,
          ...
          if (dim(Saa)[1] > 0) {
            if (rbi.slopeA.sel[[k]][i, 1] > 0) {
              pA[i] <- (rank(c(rbi.slopeA.sel[[k]][i,
                          ...
                          0.5*length(which(Saa[, 3] > 0.05 & Saa[,
                                                                 4] < 0.01)))/nsim
            }
            else {
              pA[i] <- (rank(c(rbi.slopeA.sel[[k]][i,
      ...
      if (dim(Spp)[1] > 0) {
        if (trend.reg[[i]][2, 1] > 0) {
          p.tr <- (rank(c(trend.reg[[i]][2, 1], trend.slopes[,
                                                             i][1:(nsim - 1)]))[1] + 0.5*length(which(Spp[,
                                                                                                          3] > 0.05 & Spp[, 4] < 0.05)))/nsim
        }
        else {
          p.tr <- (rank(c(trend.reg[[i]][2, 1], trend.slopes[,
                                                             i][1:(nsim - 1)]))[1] - 0.5*length(which(Spp[,
    ...
    if (dim(Spp)[1] > 0) {
      if (trend.reg[2, 1] > 0) {
        p.trend <- (rank(c(trend.reg[2, 1], trend.slopes[1:(nsim -
                                                              1)]))[1] + 0.5*length(which(Spp[, 3] > 0.05 &
                                                                                            Spp[, 4] < 0.05)))/nsim
      }
      else {
        p.trend <- (rank(c(trend.reg[2, 1], trend.slopes[1:(nsim -
          ...
          if (dim(Spp.sel)[1] > 0) {
            if (trend.reg.sel[[u]][[i]][2, 1] > 0) {
              p.sel <- (rank(c(trend.reg.sel[[u]][[i]][2,
                                                       1], slopeR[1:(nsim - 1)]))[1] + 0.5*length(which(Spp.sel[,
        ...
        if (dim(Spp.sel)[1] > 0) {
          if (trend.reg.sel[[u]][2, 1] > 0) {
            p.sel <- (rank(c(trend.reg.sel[[u]][2, 1],
                             slopeR[1:(nsim - 1)]))[1] + 0.5*length(which(Spp.sel[,
                                                                                  3] > 0.05 & Spp.sel[, 4] < 0.05)))/nsim
          }
          else {
            p.sel <- (rank(c(trend.reg.sel[[u]][2, 1],
