...
vignette: >
  %\VignetteIndexEntry{search_conv}
...
```{r message=FALSE, warning=FALSE,echo=2}
...
As above, the function stores a pdf file in the folder indicated by the argument `foldername`. 
```{r echo=FALSE,fig.align="center",message=FALSE,warning=FALSE, out.width='98%'}
require(pdftools)
