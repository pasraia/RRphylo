...
```{r echo=FALSE,message=FALSE,warning=FALSE,fig.dim=c(6,4),out.width="70%",dpi=220}
require(ape)
require(phytools)
require(geiger)
...
```{r echo=FALSE,warnings=FALSE,message=FALSE,fig.dim=c(7,3.5),out.width="70%",dpi=220}
set.seed(22)
