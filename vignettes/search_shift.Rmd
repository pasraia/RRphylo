...
vignette: >
  %\VignetteIndexEntry{search_shift}
...
Like for the automatic mode, when `search.shift` is run by specifying one or more clades to be tested, the histrograms above are stored as pdf files within the folder indicated by the argument `foldername`.
...
```{r,out.width='99%',fig.dim=c(7,6),message=FALSE,dpi=220,warning=FALSE}
require(ggtree)
require(ggplot2)
